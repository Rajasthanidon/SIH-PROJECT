...
router.post('/faculty/:id/verify-email', adminController.verifyFacultyEmail);
...
router.post('/industry/:id/verify-email', adminController.verifyIndustryEmail);
...
router.post('/placement-cell/:id/verify-email', adminController.verifyPlacementEmail);
